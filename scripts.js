...
const translations = {
    de: {
        ...
        <ul class='styled-list'>
            ...
            <li onclick="toggleContent(this)">Projektmanagement<span class="hidden-content">
                Ich habe in verschiedenen Projekten an der Uni und im Job mitgearbeitet und dabei praktische Erfahrungen gesammelt. Seit über einem Jahr leite ich ein Projekt mit einem crossfunktionalen und internationalen Team, was interessante Herausforderungen mit sich bringt und den Fokus auf gute Zusammenarbeit legt. Neben zahlreichen Projektmanagement Kursen im akademischen und beruflichen Umfeld bin ich auch zertifizierter Projektmanager (IHK).
            </span></li>
            ...
            <li onclick="toggleContent(this)">Erfahrungen im Einkauf<span class="hidden-content">
                Ich bin vor Kurzem in den Einkauf gewechselt, ein Bereich, der für mich neu ist. Durch meine technischen und analytischen Stärken unterstütze ich nun die Einführung des neuen Beschaffungssystems und erweitere meine Kompetenzen über den bisherigen BI und Finanzfokus hinaus.
            </span></li>
        </ul>`,        
    ...
    en: {
        ...
        cv_content: [
            "I have spent my entire professional career at Continental—aside from juggling a couple of school jobs before, of course! Starting with my integrated bachelor’s program, which alternated between three months of university and three months of practical phases, I got my hands dirty in various departments. I transitioned into my first job as a <em>Financial Analyst Data Warehouse</em> at the end of my studies, where I handled financial reporting, and automating processes in general, and built dashboards for many departments!",
            "Then, I moved to Vienna to work part-time as a <em>Controlling Analyst</em> at ContiTrade Austria, applying my expertise and transitioning the local reporting landscape while also getting to know local Controlling processes. After having moved most of the reporting landscape to Power BI within 1,5 years, I got an offer for my cirrent position (Regional Category Manager Purchasing Non Tradable Goods DACH) to accompany the changeover to a new purchasing tool. Nevertheless, since my move to Vienna, the main focus has been studying Digital Economy at WU. Below, you'll find a detailed overview of my areas of expertise and academic achievements. Also, feel free to <a class='link-style-1' onclick=\"window.location.href='01_files/CV_Luis_Ruhländer_public.pdf'\" download>download my CV</a>."
        ],
        cv_projects: `
        <ul class='styled-list'>
            ...
            <li onclick="toggleContent(this)">Project Management<span class="hidden-content">
                I’ve worked on numerous projects, both at university and at work, gaining valuable experience along the way. I'm also a certified project manager (IHK). Since over one year, I’m leading a project with a cross-functional and international team, which presents exciting challenges.
            </span></li>
            <li onclick="toggleContent(this)">Coding<span class="hidden-content">
            ...
            <li onclick="toggleContent(this)">Purchasing Experience<span class="hidden-content">
                I recently made a cross move into purchasing, which is a completely new area for me. Leveraging my existing technical and structural strengths, I am now helping to roll out the new purchasing system, combining process optimization with digital solutions while expanding my skill set beyond my previous finance background.
            </span></li>
        </ul>`,        
